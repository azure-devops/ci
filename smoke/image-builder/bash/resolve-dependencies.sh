...
#
# Updated from https://github.com/jenkinsci/docker/blob/master/install-plugins.sh
# Usage:
#
# FROM jenkins/jenkins:lts
# COPY azure-commons.jpi /usr/share/jenkins/ref/plugins/
# RUN resolve-dependencies.sh azure-commons
#
# This will analyze the dependencies in the copied plugin, download the dependencies if necessary.
